		...
		while (true) {
			try {
				...
				if(flag==true) {
					...
					case "msj1":
						if(this.bomber!=null)
							ClienteServidor.sharedInstance().distribuirMensajeCliente(this.nombre, sala, "hagan los casos de prueba!");
						break;
					case "msj2":
						if(this.bomber!=null)
							ClienteServidor.sharedInstance().distribuirMensajeCliente(this.nombre, sala, "!@*/)&");
						break;
					case "msj3":
						if(this.bomber!=null)
							ClienteServidor.sharedInstance().distribuirMensajeCliente(this.nombre, sala, "GOKUUUU AAAAAH!!");
						break;
					case "msj4":
						if(this.bomber!=null)
							ClienteServidor.sharedInstance().distribuirMensajeCliente(this.nombre, sala, "Papito jugo al doom");
						break;
					}
